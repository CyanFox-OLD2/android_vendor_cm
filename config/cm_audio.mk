...
ALARM_PATH := vendor/cyanfox/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/cyanfox/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/cyanfox/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/cyanfox/prebuilt/common/media/audio/ui
